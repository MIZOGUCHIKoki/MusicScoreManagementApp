...
class AddMusicalInstrumentToScores < ActiveRecord::Migration[7.1]
  def change
    add_column :scores, :piccolo, :integer, default: 0, null: false # ピッコロ
    add_column :scores, :c_fulte, :integer, default: 0, null: false # Cフルート
    add_column :scores, :oboe, :integer, default: 0, null: false # オーボエ
    add_column :scores, :english_holn, :integer, default: 0, null: false # イングリッシュホルン
